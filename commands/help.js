...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const commands = {
      ...
      'rules': {
        category: 'Moderavimas',
        description: 'Įkelia taisykles iš JSON failo su mygtukais',
        params: [
          '`failas:<failas>` — JSON failas su Discord embed formatu',
        ],
        note: 'Reikia leidimo "Manage Server"',
      },
    };
    ...
    const embed = new EmbedBuilder()
      .setColor(embedColor)
      .setTitle(getMessage('help', 'title'))
      .setDescription(getMessage('help', 'description'))
      .setTimestamp();
